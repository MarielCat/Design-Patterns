...
public class Main {
    ...
    public static void menu(){
		...
		Batallon cheemsAdaptado = new AdapterCheems(cheems);
                ...
                switch (i) {
					...
					case 3:
						try {
                        	...
                        	System.out.print(RESET);
                        	cheemsAdaptado = equiparCheems(cheemsAdaptado, teniente5);
	...
	public static Batallon equiparCheems(Batallon cheemsAdaptado, Batallon teniente){
		cheemsAdaptado = cheemsAdaptado.setArmament(cheemsAdaptado);
		cheemsAdaptado.printForCreateSoldier(cheemsAdaptado);
		teniente.getSoldado().addSoldado(cheemsAdaptado);
		System.out.println("Cheems se ha integrado al batallón de Teniente Chiquito");
		return cheemsAdaptado;
	}
